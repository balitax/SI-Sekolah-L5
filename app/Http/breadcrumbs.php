...
Breadcrumbs::register('datamenu', function($breadcrumbs) {
    $breadcrumbs->parent('home');
    $breadcrumbs->push('Data Menu', route('admin.datamenu.index'), ['icon' => '']);
});
Breadcrumbs::register('datamenucreate', function($breadcrumbs) {
    $breadcrumbs->parent('home');
    $breadcrumbs->push('Tambah Data Menu', route('admin.datamenu.create'), ['icon' => '']);
});
Breadcrumbs::register('datamenuedit', function($breadcrumbs) {
    $breadcrumbs->parent('home');
    $breadcrumbs->push('Edit Data Menu', route('admin.datamenu.edit'), ['icon' => '']);
});
