...
@section('content')
    ...
    <div class="st-pusher" id="content" ng-controller="datamenuedit">
            ...
            <div class="st-content-inner padding-none">
                <div class="container-fluid">
                    <div class="page-section third">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                {!! Breadcrumbs::render('datamenuedit') !!}
                                        ...
                                        <div id="panel_tab2_example1" class="tab-pane active">
                                            ...
                                            <form class="form-horizontal" role="form" name="dataStatisForm" ng-submit="submit({{$data->id}})">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="tipe_menu" class="form-control" ng-model="data.tipe_menu" rquired="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <select name="id_parent" class="form-control" ng-model="data.id_parent" rquired="">
