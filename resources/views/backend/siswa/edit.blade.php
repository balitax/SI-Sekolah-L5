...
@stop
@section('content')
    <div class="st-pusher" id="content" ng-controller="siswaedit" data-scrollable>
                                          ...
                                          <form class="form-horizontal" role="form" name="agendaForm" ng-submit="submit(data.id_siswa)" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <a href='{{route('admin.kelas.{id}.siswa.index',$kelas_id)}}' class="btn btn-warning">Kembali <i class="fa fa-arrow-left"></i></a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
